...
\usepackage[citestyle=authoryear-comp, %define style for citations
    ...
    isbn=false, %do not show ISBNs
    url=false, %do not show urls
    natbib=true, %provide compatibility with Natbib commands
    backend=bibtex %use bibtex as the backend; backend=biber is more powerful but also harder to install
    ]{biblatex}
\addglobalbib{../mybibfile.bib} %define bib-file located one folder higher
...
\begin{frame}{Figure and list side by side}
    \begin{figure}[htbp!]
        \begin{minipage}{0.55\linewidth}
            ...
            \caption{Source:  \citet{BornPfeifer2014JME}}
        \end{minipage}
